...
export const cubeScene = defineScene({
    ...
    main: async (resources) => {
        ...
        const skyParams = {
            ...
            molecularDensity: 1.2725, // 分子密度系数
            rayleigh: 7,  // Rayleigh 散射倍数
            mie: 3,       // Mie 散射倍数
            mieDirectionalG: 0.75, // Mie 方向性因子
            scattering: 15.0,  // 散射强度倍数（Azure 默认）
            luminance: 0.1,    // 天空亮度（无太阳/月亮时）
            exposure: 2.0,     // 曝光值
            rayleighColor: new THREE.Color(0.1433, 0.3222, 0.6819), // Rayleigh 散射颜色
            mieColor: new THREE.Color(0.9622, 0.7184, 0.3222),      // Mie 散射颜色
            // 雾气参数（Azure Sky 尺度）
            globalFogDistance: 100.0,  // Azure 默认全局雾气距离
            globalFogSmooth: 0.35,      // Azure 默认平滑过渡
            globalFogDensity: 1,      // 全局雾气密度
            heightFogDistance: 100.0,   // 高度雾气距离
            heightFogSmooth: 0.5,       // 高度雾气平滑
            heightFogDensity: 0.5,      // 高度雾气密度
            heightFogStart: 0,        // 高度雾气起始高度
            heightFogEnd: 5.0,        // 高度雾气结束高度
            fogBluishDistance: 12288.0, // Azure 默认雾气蓝色距离
            fogBluishIntensity: 0.15,   // Azure 默认雾气蓝色强度
            heightFogScatterMultiplier: 0.070, // 高度雾气散射倍数
            mieDistance: 0.5            // Mie 距离控制
        };
