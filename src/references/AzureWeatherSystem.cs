                ...
                for (int j = 0; j < m_weatherPropertyGroupList[i].weatherPropertyList.Count; j++)
                {
                    ...
                    switch (m_weatherPropertyGroupList[i].weatherPropertyList[j].propertyType)
                    {
                        ...
                        case AzureWeatherPropertyType.Curve:
                            switch (m_weatherPropertyGroupList[i].weatherPropertyList[j].targetType)
                            {
                                case AzureWeatherPropertyTargetType.Property:
                                    m_weatherPropertyGroupList[i].weatherPropertyList[j].propertyInfo?.SetValue(m_weatherPropertyGroupList[i].weatherPropertyList[j].targetComponent, m_weatherPropertyGroupList[i].weatherPropertyList[j].floatOutput);
                                    break;
                                case AzureWeatherPropertyTargetType.Field:
                                    m_weatherPropertyGroupList[i].weatherPropertyList[j].fieldInfo?.SetValue(m_weatherPropertyGroupList[i].weatherPropertyList[j].targetComponent, m_weatherPropertyGroupList[i].weatherPropertyList[j].floatOutput);
                                    break;
                        ...
                        case AzureWeatherPropertyType.Gradient:
                            ...
                            {
                                case AzureWeatherPropertyTargetType.Property:
                                    m_weatherPropertyGroupList[i].weatherPropertyList[j].propertyInfo?.SetValue(m_weatherPropertyGroupList[i].weatherPropertyList[j].targetComponent, m_weatherPropertyGroupList[i].weatherPropertyList[j].colorOutput);
                                    break;
                                case AzureWeatherPropertyTargetType.Field:
                                    m_weatherPropertyGroupList[i].weatherPropertyList[j].fieldInfo?.SetValue(m_weatherPropertyGroupList[i].weatherPropertyList[j].targetComponent, m_weatherPropertyGroupList[i].weatherPropertyList[j].colorOutput);
                                    break;
                                case AzureWeatherPropertyTargetType.MaterialProperty:
                        ...
                        case AzureWeatherPropertyType.Position:
                            ...
                            {
                                case AzureWeatherPropertyTargetType.Property:
                                    m_weatherPropertyGroupList[i].weatherPropertyList[j].propertyInfo?.SetValue(m_weatherPropertyGroupList[i].weatherPropertyList[j].targetComponent, m_weatherPropertyGroupList[i].weatherPropertyList[j].vector3Output);
                                    break;
                                case AzureWeatherPropertyTargetType.Field:
                                    m_weatherPropertyGroupList[i].weatherPropertyList[j].fieldInfo?.SetValue(m_weatherPropertyGroupList[i].weatherPropertyList[j].targetComponent, m_weatherPropertyGroupList[i].weatherPropertyList[j].vector3Output);
                                    break;
                                case AzureWeatherPropertyTargetType.MaterialProperty:
